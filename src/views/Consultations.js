...
const Consultations = (props) => {
  ...
  const [activities, setActivities] = React.useState([
    { id: 1, day: '29', month: 'setembro', title: 'Consulta: Cirurgião Plástico', description: 'Valor: R$300,00 - Realizada' },
    { id: 2, day: '29', month: 'setembro', title: 'Consulta: Cirurgião Plástico', description: 'Valor: R$300,00 - Realizada' },
    { id: 3, day: '29', month: 'setembro', title: 'Consulta: Cirurgião Plástico', description: 'Valor: R$300,00 - Realizada' },
    { id: 4, day: '29', month: 'setembro', title: 'Consulta: Cirurgião Plástico', description: 'Valor: R$300,00 - Cancelada' },
    { id: 5, day: '29', month: 'setembro', title: 'Consulta: Cirurgião Plástico', description: 'Valor: R$300,00 - Realizada' },
  ]);

  const [solicitations, setSolicitations] = React.useState([
    { id: 1, day: '27', month: 'julho', title: 'Consulta: Cirurgião Plástico', description: 'Valor: R$200,00 - Pendente' },
    { id: 2, day: '17', month: 'agosto', title: 'Consulta: Cirurgião Plástico', description: 'Valor: R$500,00 - Pendente' },
    { id: 3, day: '05', month: 'setembro', title: 'Consulta: Cirurgião Plástico', description: 'Valor: R$350,00 - Realizada' },
    { id: 4, day: '05', month: 'outubro', title: 'Consulta: Cirurgião Plástico', description: 'Valor: R$300,00 - Realizada' },
    { id: 5, day: '15', month: 'novembro', title: 'Consulta: Cirurgião Plástico', description: 'Valor: R$300,00 - Realizada' },
  ]);
  ...
  return (
    <Styled.Container style={{ paddingTop: 0 }}>
      ...
      <Styled.ScrollContainer>
        ...
        <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center', backgroundColor: '#F7F7F7', width: '100%', paddingVertical: 30, paddingHorizontal: 10, marginBottom: 30, flexDirection: 'row', flexWrap: 'nowrap' }}>
          <Text style={{ fontWeight: '400', fontSize: 24, color: Styled.colors.buttonBg1, flex: 1 }}>Agenda</Text>
        </View>
        ...
        <TouchableOpacity style={{ alignItems: 'center', justifyContent: 'center', width: '95%', marginVertical: 10, flexDirection: 'row', flexWrap: 'nowrap', height: 80, }}>
          ...
          <View style={{ borderTopRightRadius: 10, borderBottomRightRadius: 10, flex: 4, backgroundColor: Styled.colors.buttonBg1, flexDirection: 'row', flexWrap: 'nowrap', height: '100%', alignItems: 'center', justifyContent: 'center', paddingHorizontal: 10 }}>
            <View style={{ flex: 1 }}>
              <Text style={{ fontWeight: '600', fontSize: 18, color: "#fff" }}>Pagar consulta</Text>
